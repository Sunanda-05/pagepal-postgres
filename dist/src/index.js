...
const adminApplicationRoutes_1 = __importDefault(require("./routes/adminApplicationRoutes"));
const authorApplicationRoutes_1 = __importDefault(require("./routes/authorApplicationRoutes"));
...
app.use("/collection", collectionRoutes_1.default);
app.use("/tag", tagRoutes_1.default);
app.use("/admin", adminApplicationRoutes_1.default);
app.use("/author", authorApplicationRoutes_1.default);
